...
class SupabaseService {
  ...
  /// Returns true when a Supabase user session is active.
  ...
  /// Signs out the active Supabase user.
  ...
  /// Registers a new user account on Supabase with metadata.
  ...
  /// Sends an 8-digit OTP code to the specified email address.
  ...
  /// Verifies an 8-digit OTP code sent to email.
  ...
  /// Updates the authenticated user's password to a new password.
