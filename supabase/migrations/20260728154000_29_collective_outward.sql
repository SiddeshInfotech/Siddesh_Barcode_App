-- =============================================================================
-- 29 — COLLECTIVE OUTWARD DISPATCHES & BATCH ID IN HISTORY VIEW
-- =============================================================================

-- 1. Redefine v_inward_history to include batch_id
...
-- 2. Redefine save_outward to support p_batches parameter
